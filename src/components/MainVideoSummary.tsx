    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-center gap-2">
          <span className="px-2.5 py-1 rounded-md bg-muted border border-slate-700 text-xs font-medium text-muted-foreground">
      ...
      {/* Video embed */}
      {chapter.videoId ? (
        <div className="relative pt-[56.25%] rounded-xl overflow-hidden border border-border bg-muted shadow-2xl shadow-black/40">
          <iframe
        ...
        <div className="relative pt-[56.25%] rounded-xl overflow-hidden border border-border bg-card">
