    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      <main className="flex-grow">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/gallery"
                  className="inline-flex items-center gap-2 px-6 py-3.5 bg-emerald-500 hover:bg-emerald-400 text-foreground font-semibold rounded-lg transition-all duration-200 shadow-lg shadow-emerald-500/25 hover:-translate-y-0.5"
                >
                  Get Started
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3.5 border border-slate-700 hover:border-emerald-500/50 text-slate-300 hover:text-foreground font-semibold rounded-lg transition-all duration-200 hover:-translate-y-0.5"
                >
              ...
              {continueData && (
                <div className="mt-8">
                  ...
                  <Link
                    ...
                    className="group flex items-center gap-4 p-4 rounded-xl border border-slate-700/60 bg-card/80 hover:border-emerald-500/40 hover:bg-card transition-all duration-200 max-w-sm"
                  >
                    {/* Thumbnail */}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mb-1.5">
                        ...
                        <span className={cn(
                          ...
                          continueData.isComplete ? "text-emerald-400" : "text-muted-foreground"
                        )}>
            ...
            <div className="relative lg:pl-6">
              <div className="relative bg-card border border-slate-700/50 rounded-2xl overflow-hidden shadow-2xl">
                <div className="flex items-center gap-2 px-4 py-3 border-b border-border bg-background">
                  <div className="w-3 h-3 rounded-full bg-red-500/70" />
                  <div className="w-3 h-3 rounded-full bg-yellow-500/70" />
                  <div className="w-3 h-3 rounded-full bg-emerald-500/70" />
                  <span className="ml-2 text-xs text-muted-foreground font-mono">smartify.app/course</span>
                </div>
                <div className="p-6">
                  ...
                  <h3 className="text-base font-semibold text-foreground mt-3 mb-4">
              ...
              <div className="absolute -top-3 -right-3 bg-emerald-500 text-foreground text-xs font-bold px-3 py-1.5 rounded-full shadow-lg shadow-emerald-500/40">
                ✨ AI Generated
              </div>
            </div>
          </div>
        ...
        <section className="py-24 bg-card">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">Why Choose Smartify AI</h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Everything you need to master any topic — powered by AI.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={f.title} className="group p-6 rounded-xl border border-border bg-background hover:border-emerald-500/40 hover:bg-card transition-all duration-300">
        ...
        <section className="py-24">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">How Smartify AI Works</h2>
              <p className="text-muted-foreground text-lg">Four steps from idea to mastery</p>
            </div>
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                <div key={item.step} className="relative p-6 rounded-xl border border-border bg-card hover:border-emerald-500/30 transition-colors">
                  {i < 3 && (
        ...
        <section className="py-24 bg-card">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">What Our Learners Say</h2>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={r.name} className="p-6 rounded-xl border border-border bg-background hover:border-emerald-500/20 transition-colors">
                  <div className="flex mb-4">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-emerald-400 text-emerald-400" />
                    ))}
                  </div>
                  <p className="text-muted-foreground text-sm leading-relaxed mb-6 italic">&ldquo;{r.text}&rdquo;</p>
          ...
          <div className="max-w-3xl mx-auto px-6 text-center">
            <div className="p-12 rounded-2xl border border-emerald-500/20 bg-gradient-to-b from-emerald-500/10 to-transparent">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link
                  href="/gallery"
                  className="inline-flex items-center gap-2 px-6 py-3.5 bg-emerald-500 hover:bg-emerald-400 text-foreground font-semibold rounded-lg transition-all shadow-lg shadow-emerald-500/25"
                >
                  Explore Courses
                  <ArrowRight className="w-4 h-4" />
                </Link>
                <Link
                  href="/create"
                  className="inline-flex items-center gap-2 px-6 py-3.5 border border-slate-700 hover:border-emerald-500/50 text-slate-300 hover:text-foreground font-semibold rounded-lg transition-all"
                >
                  Create a Course
                </Link>
              </div>
      ...
      <footer className="bg-card border-t border-border py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            <div>
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="font-bold text-foreground">Smartify</span>
              </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                {[Facebook, Twitter, Linkedin, Instagram].map((Icon, i) => (
                  <a key={i} href="#" className="w-8 h-8 rounded-lg border border-slate-700 flex items-center justify-center text-muted-foreground hover:text-emerald-400 hover:border-emerald-500/40 transition-all">
          ...
          <div className="pt-8 border-t border-border text-center text-sm text-slate-600">
      ...
      {showVideo && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-card border border-slate-700 rounded-2xl w-full max-w-3xl overflow-hidden shadow-2xl">
            <div className="flex items-center justify-between px-5 py-3.5 border-b border-border">
              <span className="text-sm font-medium text-slate-300">Demo Video</span>
              <button
                onClick={() => setShowVideo(false)}
                className="w-7 h-7 rounded-lg border border-slate-700 flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-slate-600 transition-all"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
